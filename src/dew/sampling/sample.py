...
@overload
def sample[StateT](denoise: Denoiser, x_T: jax.Array, steps: int, *, solver: Solver[StateT],
                   guidance: CFG | None = None, key: jax.Array, times: None = None,
                   final_denoise: bool = True) -> jax.Array: ...


@overload
def sample[StateT](denoise: Denoiser, x_T: jax.Array, steps: None = None, *, solver: Solver[StateT],
                   guidance: CFG | None = None, key: jax.Array, times: ArrayLike | Sequence[float],
                   final_denoise: bool = True) -> jax.Array: ...


def sample[StateT](denoise: Denoiser, x_T: jax.Array, steps: int | None = None, *, solver: Solver[StateT],
