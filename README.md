...
The MLA layers of DeepSeek and Kimi K2 need `attention_impl="reference"`;
`auto` rejects their query and value head widths.
`MaskedDiffusionObjective` takes no `pretrained`
