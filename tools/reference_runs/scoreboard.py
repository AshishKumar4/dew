...
ROWS: list[dict] = [
    ...
    {"id": "qwen3-4gpu-3090-b8", "path": "dense LM", "model": "Qwen3-0.6B", "gpus": 4,
     ...
     "dew": [("dew data=4", "qwen3-4gpu-3090/after-775e68d9/qwen3/dew-data4-bf16.json", DEW_BF16),
             ("dew fsdp=4", "qwen3-4gpu-3090/after-775e68d9/qwen3/dew-fsdp4-bf16.json", DEW_BF16)],
    ...
    {"id": "qwen3-4gpu-3090-b16", "path": "dense LM", "model": "Qwen3-0.6B", "gpus": 4,
     ...
     "dew": [("dew data=4", "qwen3-4gpu-3090/after-775e68d9/qwen3/b16-dew-data4.json", DEW_BF16),
             ("dew fsdp=4", "qwen3-4gpu-3090/after-775e68d9/qwen3/b16-dew-fsdp4.json", DEW_BF16)],
     "reference": [("torch.compile DDP", "qwen3-4gpu-3090/after-775e68d9/qwen3/b16-torch-ddp-compile.json",
                   ...
                   ("MaxText data=4", "qwen3-4gpu-3090/after-775e68d9/qwen3/maxtext-data-b16.json", MAXTEXT_RECIPE),
                   ("MaxText fsdp=4", "qwen3-4gpu-3090/after-775e68d9/qwen3/maxtext-fsdp-b16.json", MAXTEXT_RECIPE)],
    ...
    {"id": "moe-4gpu-3090", "path": "MoE", "model": "99M Qwen3-MoE shape (8 experts, top 2)", "gpus": 4,
     ...
     "dew": [("dew expert=4", "moe-4gpu-3090/after-775e68d9/moe/dew-expert4-bf16.json",
             ...
             ("dew data=4", "moe-4gpu-3090/after-775e68d9/moe/dew-data4-bf16.json", DEW_BF16)],
     "reference": [("torch.compile FSDP2, bf16 experts", "moe-4gpu-3090/after-775e68d9/moe/torch-fsdp2-compile.json",
    ...
    {"id": "dit-4gpu-3090", "path": "DiT diffusion", "model": "SimpleDiT (patch 4, width 384, 8 layers) at 64 px",
     ...
     "dew": [("dew data=4", "dit-4gpu-3090/after-775e68d9/dit/dew-data4-bf16.json", "bf16 compute"),
             ("dew fsdp=4", "dit-4gpu-3090/after-775e68d9/dit/dew-fsdp4-bf16.json", "bf16 compute")],
