...
(flaxdiff 0.2.8). It runs here, on the CPU at fp32 whatever else the machine
has (a GPU rounds the last bit of the table and the output its own way), on
a model small enough to commit, and the fixture holds everything a parity
test needs without FlaxDiff installed:
