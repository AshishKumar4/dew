...
Design, 2026-09-03. Not built, except where a ticket in section 9 says otherwise. Every file and line cites `main` at `102baa4`, the commit the review in `docs/design/review-2026-09-03.md` read. The seven fix branches merged on top of it (`3d30a35` through `b39c62a`) moved some of those lines; the review names the fix commit for each.
