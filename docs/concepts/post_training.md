...
Multi-turn text episodes run through `EpisodeRollout` and user-supplied environments, including coordinated JAX process pools and the local `SubprocessEnvironment`. Remote sandbox adapters and mid-tool recovery are not provided.
