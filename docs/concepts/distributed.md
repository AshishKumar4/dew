...
A counter of consecutive non-finite losses rides along with the step on device and is read on the logging cadence. A streak of `BAD_LOSS_STEPS` (5) stops the run.
